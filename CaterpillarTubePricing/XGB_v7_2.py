...
c=[0.35,0.08,0.45,0.12]
preds_test=c[0]*pred1+c[1]*pred2+c[2]*pred3+c[3]*pred4
preds_valid=c[0]*pred_pow1_valid+c[1]*pred_log2_valid+c[2]*pred_pow3_valid+c[3]*pred_log4_valid
print summary_valid
print rmse_log(valid_Y,preds_valid)
preds_holdout=c[0]*pred_pow1_holdout+c[1]*pred_log2_holdout+c[2]*pred_pow3_holdout+c[3]*pred_log4_holdout
